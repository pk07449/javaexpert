package com.pnakaj.interviewquestion.hibernate.relationshipmanage.inverse.config;
 ...
 */
@Configuration
@ComponentScan("com.pnakaj.interviewquestion.hibernate.relationshipmanage.inverse")
...
public class AppConfig {
    ...
    public LocalSessionFactoryBean getLocalSessionFactory() {
        ...
        localSessionFactoryBean.setPackagesToScan("com.pnakaj.interviewquestion.hibernate.relationshipmanage.inverse.domain");
