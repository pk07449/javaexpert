 ...
 */
@Configuration
@ComponentScan("com.pnakaj.spring.transaction.isolation.readuncommited")
...
//        <property name="defaultAutoCommit" value="false" />
    ...
    public LocalSessionFactoryBean getLocalSessionFactory() {
        ...
        localSessionFactoryBean.setPackagesToScan("com.pnakaj.spring.transaction.isolation.readuncommited.domain");
